...
#TODO
# Create a tokenizer for English-to-French translation using T5-Small
from transformers import AutoTokenizer

tokenizer = AutoTokenizer.from_pretrained("t5-small")
# Create an English-to-French translation pipeline using T5-Small
translator_pipeline = pipeline(model="t5-small", task="translation_en_to_fr", tokenizer=tokenizer)
...
translator_pipeline_hnlp = pipeline(model="Helsinki-NLP/opus-mt-en-fr", task="translation_en_to_fr", tokenizer=tokenizer)
