...
prompt =\
"""Write sequence of hashtags from post messages:

[post messages]: "🚀 Introducing Llama 3: Meta's Latest AI Breakthrough 🚀 Meta's new open-source LLM, Llama 3, stands out as the best in the market! Built with a massive investment, Llama 3 is trained on a 15 trillion token dataset and utilizes 24,000 GPUs, offering unprecedented power and accessibility. 👉 Key Models: From the compact 8B to the robust 70B versions. Plus, watch out for the upcoming 400B model! 🔗 Test it out: Try Llama 3 through the Meta AI interface, Clouder marketplace, or even locally on your laptop with Ollama. Experience its lightning-fast token generation and real-time image generation for free! 📈 Performance & Drawbacks: Despite its advanced capabilities, it’s worth noting the Llama 3 model has a shorter context length of 8K, which may limit some applications, and the knowledge base might be slightly outdated. 💬 Engage & Explore: If you’re as intrigued as I am, give this a read, clap, and follow for more deep dives into cutting-edge AI developments! Let's discuss how Llama 3 is shaping the future of AI!"
[hashtags]: "#AI #MachineLearning #OpenSource #Meta #Llama3 #Innovation"
###
[post messages]: "Robots venturing into space!🌌 In August 2023, GITAI, a Japanese startup specializing in space robotics, secured an additional $15 million to further advance their lunar technology development.The lunar robotic rover "R1" is equipped to handle various tasks on the moon, including exploration, mining, and inspection. At present, GITAI is actively developing both a lunar rover and a specialized robotic arm designed for space installations. Excitingly, they're planning to conduct tests of this robotic arm aboard the International Space Station! 🛰️"
[hashtags]: "#ai #machinelearning #robotics #innovation #tech #space"
###
[post messages]: "👉 Dynamic Duos 🤖 Prompt: Image series: Dynamic Duos. Each time I say "next" you choose a different pair of household objects that typically work together, turned into Pixar-style anthropomorphic characters cooperating in a task. For example, a hammer and nail working together to hang a picture, or a paintbrush and paint can collaborating to refresh a wall. The scenes are depicted in high-quality, ultra-high-resolution photorealistic style, with additional elements to enrich the story. 16:9 image format."
[hashtags]:"""
