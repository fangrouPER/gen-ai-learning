...
# TODO Construct a question-answering pipeline

from transformers import AutoModelForQuestionAnswering

model4qa = AutoModelForQuestionAnswering.from_pretrained(model_name)
...
# Infer signature for the model using input and output examples
signature = mlflow.models.infer_signature(input_example)

# Start the run
mlflow.start_run(run_name="LLMOps_Lab_QA_Pipeline")
...
# TODO search the model with model_name
...
# TODO promote the first version to the staging
model_version = 1
...
# TODO load model from staging 
staging_model = mlflow.pyfunc.load_model(model_uri=f"models:/{model_name}/{model_version}")

# TODO use dataset for inference
...
# TODO promote the model from staging to production
model_version = 1
